...
- **Docs**: Add Markdown files to `website/docs/`.
- **Sidebars**: If using autogenerated sidebars, the new files will appear automatically. Otherwise, update `website/sidebars.js`.

### Deployment

The documentation is automatically deployed to GitHub Pages via a GitHub Action on push to `main`.